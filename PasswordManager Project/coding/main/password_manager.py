...
def starting():
    ...
    loading()
    print(
        f"Welcome to KhodeNima's Password Manager version : \33[31m{current_version}\33[34m"
    )
    sleep(4)
...
def Collect_UserName():
    ...
    while LOOP1:
        ...
        print("")
        print(
            "Note That \33[31mUserName's\33[34m can only contain \33[31mUpperCase\33[34m , \33[31mLowerCase Letter's\33[34m , \33[31mNumber's \33[34m."
        )
        UserName.inputted_username = input(
            "Please Chose a \33[31mUserName\33[34m For Your \33[31mNew account\33[34m : "
        )
        ...
        if (
            ...
            while LOOP2:
                ...
                if username_confirmation == "yes":
                    ...
                    clean()
                    print(
                        "That Is not a \33[31myes\33[34m or \33[31mno \33[34m, Please try again."
                    )
                    sleep(3)
            ...
            print(
                "This \33[31m UserName \33[34m Allready Exist's , Please try another UserName"
            )
            ...
            print(
                "\33[31This username does not meet the requirement's to be used.\33[34m \n\
...
def Main_Menu():
    ...
    while LOOP1 == True:
        ...
        if User_Desired_Operation in [
            ...
            BirthDate_Check = Users_Info["Users"][UserName.inputted_username].get(
                "Birth_Date", False
            )
